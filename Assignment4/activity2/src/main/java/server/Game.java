 ...
 * I used this class in my SockBaseServer to create a new game and keep track of the current image even in different threads.
...
public class Game {
    ...
    public Game(){
        ...
        // You are totally free to also use just Strings in your Server class instead of this class
    ...
    /**
     * Method returns last row char
     * @return char of last row
     */
    public char getLastRow() {
        return original[original.length - 1][0];
    }

    /**
     * Method returns last col char
     * @return char of last col
     */
    ...
    /**
     * Shows thechosen tiles and then hides them again. Returns the board with one showing.
     * @param tile1row row for tile 1
     * @param tile1col column for tile 1
     * @return String of board with the 1 tile showing
     */
    public String tempFlipTiles(int tile1row, int tile1col) {
     ...
     * @param tile1row row for tile 1
     * @param tile1col column for tile 1
     * @param tile2row row for tile 2
     * @param tile2col column for tile 2
     * @return String of board with the 2 tile showing
     */
    public String tempFlipTiles(int tile1row, int tile1col, int tile2row, int tile2col) {
        hidden[tile1row][tile1col] = original[tile1row][tile1col];
    ...
    /**
     * Method that replaces a character, needed when a match was found
     * You can of course also change it to get to rows and two cols if you like
     */
    public synchronized void replaceCharacters(int row1Number, int col1Number, int row2Number, int col2Number) {
        hidden[row1Number][col1Number] = original[row1Number][col1Number];
        hidden[row2Number][col2Number] = original[row2Number][col2Number];
        getBoard();
    }
